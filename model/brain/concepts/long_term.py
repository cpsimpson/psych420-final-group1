...
class LongTermMemory:
    ...
    def lookup(self, valence, arousal, dominance):
        ...
        return list(set(valence_values).intersection(set(arousal_values)).intersection(set(dominance_values)))
    ...
    def retrieve(self):
        ...
        return list(words_v.intersection(words_a).intersection(words_d))
